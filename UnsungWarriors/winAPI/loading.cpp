...
{
	//로딩화면 백그라운드 이미지 초기화
	_background = IMAGEMANAGER->addImage("bgLoadingScene", "Images/loadingBg.bmp", WINSIZEX, WINSIZEY);

	//로딩바 이미지 초기화
	IMAGEMANAGER->addImage("loadingBarFront", "loadingBarFront.bmp", 700, 20);
	IMAGEMANAGER->addImage("loadingBarBack", "loadingBarBack.bmp", 700, 20);
	_bird = IMAGEMANAGER->addFrameImage("LoadingBird", "Images/bird.bmp", 720, 126, 8, 1, true, RGB(255, 0, 255));
...
void loading::render()
{
	...
	_bird->frameRender(getMemDC(), 450 + _loadingBar->getWidth(), _loadingBar->get_Y() - 120, frameX, frameY);
