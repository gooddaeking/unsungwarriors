...
HRESULT mainGame::init()
{
	...
	SCENEMANAGER->addScene("필드화면", new fieldMap);
	SCENEMANAGER->addScene("던전1화면", new cave1);
	SCENEMANAGER->addScene("던전2화면", new cave2);
	SCENEMANAGER->addScene("던전3화면", new cave3);
	SCENEMANAGER->addScene("보스맵", new bossMap);
